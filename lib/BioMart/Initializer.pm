...
sub _new {
     ...
     system("/bin/cp $registryFile $copyRegistryFile");
     ...
     {
          if (-e "$registryFile.cached") { system("/bin/cp $registryFile.cached $registryFile.cached_backup"); }
          if (-e "$registryFile.min_cached_mem") { system("/bin/cp $registryFile.min_cached_mem $registryFile.min_cached_mem_backup"); }
          if (-e "$registryFile.min_cached_disk") { system("/bin/cp $registryFile.min_cached_disk $registryFile.min_cached_disk_backup"); }
          if (-e "$1Cached") { system("/bin/cp -r $1Cached $1Cached_backup"); }   
